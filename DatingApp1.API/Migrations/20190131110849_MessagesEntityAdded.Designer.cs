...
namespace DatingApp1.API.Migrations
{
    ...
    [Migration("20190131110849_MessagesEntityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatingApp1.API.Models.Messages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<bool>("RecipaintDeleted");

                    b.Property<int>("RecipaintId");
            ...
            modelBuilder.Entity("DatingApp1.API.Models.Messages", b =>
                {
                    b.HasOne("DatingApp1.API.Models.User", "Recipaint")
                        .WithMany("MessagesRcvd")
                        .HasForeignKey("RecipaintId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DatingApp1.API.Models.User", "Sender")
